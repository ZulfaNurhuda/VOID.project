...
export default function SocialLoginButtons() {
  ...
  const hasAny = providers.google || providers.github || providers.discord;
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-3 my-4">
        ...
        <span className="text-xs text-void-muted">or continue with</span>
        <div className="flex-1 border-t border-void-border" />
      </div>
      <div className="flex flex-col gap-2">
        {providers.google && (
          <a
            ...
            className="flex items-center justify-center gap-3 px-4 py-2 border border-void-border bg-void-surface hover:bg-void-surface-2 text-void-text text-sm transition-colors"
          >
